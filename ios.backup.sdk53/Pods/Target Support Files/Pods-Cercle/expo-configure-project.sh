...
with_node \
  ...
  --target "/Users/clemencebouchot/Desktop/cercle-final-sdk53-react19/ios/Pods/Target Support Files/Pods-Cercle/ExpoModulesProvider.swift" \
  --entitlement "/Users/clemencebouchot/Desktop/cercle-final-sdk53-react19/ios/Cercle/Cercle.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-clipboard" "expo-constants" "expo-contacts" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-linking"
